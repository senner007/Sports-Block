...
vectorization_tests = {
    ...
    "østrig albaniens indonesien grækenland fodbold østrig" : ['xland', 'xland', 'xland','xland', 'fodbold', 'xland'],
    "østrigsk fodbold østrigsk" : ['xnationality', 'fodbold', 'xnationality'],
