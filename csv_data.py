...
def get_sports():
    ...
    df = pd.concat([df_sport_latest, df_sport_latest_tv2, df_sport_2019, df_sport_2020, df_sport_2022, df_sport_politiken, df_ishockey_tv2, df_badminton_tv2, df_nfl_tv2,df_cykling_tv2, df_fodbold_tv2, df_fodbold_2_tv2, df_formel_1_tv2, df_haandbold_tv2] )
